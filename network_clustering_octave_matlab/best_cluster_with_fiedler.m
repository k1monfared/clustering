function [idx, q] = best_cluster_with_fiedler(A,max_k)
    % Inputs:
    ...
    [idx_history,q_history] = hierarchical_partition_with_fiedler_sorted(A,max_k); %find all clustrings of all sizes
